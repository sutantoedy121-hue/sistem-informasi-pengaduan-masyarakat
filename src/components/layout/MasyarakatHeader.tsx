...
const primaryTabs = [
  {
    ...
    isActive: (p: string) => p === "/masyarakat",
  },
  {
...
/** Shell header dashboard masyarakat: brand, info akun, navigasi tab. */
export default function MasyarakatHeader({ fullName, email }: Props) {
    ...
    <header className="sticky top-0 z-40 border-b border-slate-200/70 bg-white/85 backdrop-blur-lg">
      <div className="container-page flex h-16 items-center justify-between gap-3">
        ...
        <div className="hidden items-center gap-2 md:flex">
          <NotificationBell />
          <Link href="/masyarakat/baru" className="btn-primary !px-4 !py-2 text-xs">
